...
public class TeacherAttendanceController {
    ...
    @FXML
    private DatePicker datePicker; // For past attendance selection
    @FXML
...
private ProgressBar attendanceProgress;
    ...
    public void initialize() {
        ...
        // Load students when period or date changes
        periodComboBox.valueProperty().addListener((obs, oldVal, newVal) -> {
            if (newVal != null)
                loadStudentsForSelectedDate();
        });
        if (datePicker != null) {
...
private void updateAttendanceStats() {
    ...
    /** Load periods for selected subject */
    ...
    private void loadStudentsForSelectedDate() {
        ...
        try (Connection conn = DBConnection.getConnection();
            ...
            if (studentList.isEmpty()) {
                statusLabel.setText("⚠ No attendance records found for " + selectedDate);
            } else {
    ...
    /** View / Edit past attendance (simply triggers table reload) */
    @FXML
