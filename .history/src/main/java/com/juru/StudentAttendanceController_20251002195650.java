...
public class StudentAttendanceController {
    ...
    private void setupTableColumns() {
        colSubjectCode.setCellValueFactory(data -> javafx.beans.property.SimpleStringProperty.stringExpression(data.getValue().getSubjectCode()));
        colSubjectName.setCellValueFactory(data -> javafx.beans.property.SimpleStringProperty.stringExpression(data.getValue().getSubjectName()));
        colTotal.setCellValueFactory(data -> javafx.beans.property.SimpleIntegerProperty.integerExpression(data.getValue().getTotal()));
        colAttended.setCellValueFactory(data -> javafx.beans.property.SimpleIntegerProperty.integerExpression(data.getValue().getAttended()));
        colPercentage.setCellValueFactory(data -> javafx.beans.property.SimpleStringProperty.stringExpression(data.getValue().getPercentage()));
    }
    ...
    public static class AttendanceRecord {
        ...
        public javafx.beans.property.StringProperty getSubjectCode() { return new javafx.beans.property.SimpleStringProperty(subjectCode); }
        public javafx.beans.property.StringProperty getSubjectName() { return new javafx.beans.property.SimpleStringProperty(subjectName); }
        public javafx.beans.property.IntegerProperty getTotal() { return new javafx.beans.property.SimpleIntegerProperty(total); }
        public javafx.beans.property.IntegerProperty getAttended() { return new javafx.beans.property.SimpleIntegerProperty(attended); }
        public javafx.beans.property.StringProperty getPercentage() { return new javafx.beans.property.SimpleStringProperty(percentage); }
    }
}
