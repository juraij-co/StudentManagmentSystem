...
public class StudentDashboardController {
    ...
    private void openDashboard() throws Exception {
        rootPane.setCenter(FXMLLoader.load(getClass().getResource("/com/juru/student-dashboard.fxml")));
    }

    @FXML
    private void openViewAttendance() throws Exception {
        rootPane.setCenter(FXMLLoader.load(getClass().getResource("/com/juru/StudentAttendanceView.fxml")));
    }
