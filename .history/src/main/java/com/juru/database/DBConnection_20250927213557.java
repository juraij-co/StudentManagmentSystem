...
public class DBConnection {
    ...
    private static final String DEFAULT_URL = "jdbc:mysql://localhost:3306/student_mgmt";
    ...
    // Create core tables to match db/studentdb.sql and add a users table for authentication
    ...
    String createSemesters = "CREATE TABLE IF NOT EXISTS semesters ("
        + "id INT AUTO_INCREMENT PRIMARY KEY,"
    ...
    String createTeacherSubjects = "CREATE TABLE IF NOT EXISTS teacher_subjects ("
        + "id INT AUTO_INCREMENT PRIMARY KEY,"
    ...
    String createStudentSubjects = "CREATE TABLE IF NOT EXISTS student_subjects ("
        + "id INT AUTO_INCREMENT PRIMARY KEY,"
    ...
    try (java.sql.Statement stmt = conn.createStatement()) {
        ...
        stmt.executeUpdate(createSemesters);
        stmt.executeUpdate(createSubjects);
        stmt.executeUpdate(createUsers);
        stmt.executeUpdate(createTeachers);
        stmt.executeUpdate(createStudents);
        stmt.executeUpdate(createTeacherSubjects);
        stmt.executeUpdate(createStudentSubjects);
